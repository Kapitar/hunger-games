<template>
  <div class="timeline">
    <div class="container">
      <h1 class="text-center">DAY 2</h1>
      <p class="text-center">
        <router-link class="prev" :to="{ name: 'timeline_day1' }">PREV</router-link>
        ...
        <div class="col-6">
          <table>
            <tr class="text-center">
              <td>
                <div class="avatar3 tribute1-male"></div>
              ...
              <td>
                <div class="avatar3 tribute2-female"></div>
                <p class="tribute-name text-center">District 2</p>
              </td>
              <td>
                <div class="avatar3 tribute3-male"></div>
            ...
            <tr class="text-center">
              ...
              <td>
                <div class="avatar2 tribute11-female"></div>
                <p class="tribute-name text-center">District 11</p>
              </td>
              <td>
